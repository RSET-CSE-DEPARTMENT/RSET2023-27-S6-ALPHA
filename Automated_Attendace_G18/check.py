...
# =====================================================================
# MODULE 2: CAMERA & UI PROCESS (Main Loop) LOAD STUDENTS TO MEMORY
# =====================================================================
def run_class_session(class_name, subject, period, date_input):
    ...
    attendance_sheet = {uid: [False] * TOTAL_SNAPSHOTS for uid in all_uids}# Initialize attendance sheet with False for all snapshots
    uid_to_name = dict(zip(all_uids, all_names))# Create a mapping from UID to Name for easy lookup during attendance marking
